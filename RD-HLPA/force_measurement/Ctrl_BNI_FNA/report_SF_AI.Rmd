...
std.prior <- brm(
  ...
  iter = 4e4,
  sample_prior = "only",
  file = paste0(rds_folder_name, "ctrl_bni_fna_0h_check_prior_vGaussian_2023_04_07_v2.rds"),
...
std.fit <-  update(std.prior, 
                   ...
                   seed = my.seed, 
                   cores = my.cores,
                   file = paste0(rds_folder_name, "ctrl_bni_fna_0h_model_summary_vGaussian_v20230407_v2.rds"),
                   file_refit = "on_change")
summary(std.fit)
...
std.prior <- brm(
  ...
  iter = 4e4,
  sample_prior = "only",
  file = paste0(rds_folder_name, "ctrl_bni_fna_3h_check_prior_vGaussian_v20230407_v2.rds"),
  file_refit = "on_change"
)
...
std.fit <-  update(std.prior, 
                   ...
                   seed = my.seed,
                   cores = my.cores,
                   file = paste0(rds_folder_name, "ctrl_bni_fna_3h_model_summary_vGaussian_v20230407_v2.rds"),
                   file_refit = "on_change")
summary(std.fit)
...
std.prior <- brm(
  ...
  iter = 4e4,
  sample_prior = "only",
  file = paste0(rds_folder_name, "ctrl_bni_fna_0h_3h_check_prior_vGaussian_335_v20230406_v2.rds"),
  file_refit = "on_change"
)
...
std.fit <-  update(std.prior, 
                   ...
                   seed = my.seed, 
                   cores = my.cores,
                   file = paste0(rds_folder_name, "ctrl_bni_fna_0h_3h_model_summary_vGaussian_v20230407_v2.rds"),
                   file_refit = "on_change")
summary(std.fit)
