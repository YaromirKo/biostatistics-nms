---
title: "Bilateral rhizotomy. Analyse PAS UBI vs SO (L, R; hand, machine)"
...
rds_folder_name <- "../../rds/bilateral_rhizotomy/3_groups/pas/"
...
std.prior <- brm(
  ...
  iter = 4e4,
  sample_prior = "only",
  file = paste0(rds_folder_name, "so_check_prior_machine_1.rds"),
  file_refit = "on_change"
)
...
std.fit <-  update(std.prior, 
                   ...
                   seed = my.seed, 
                   cores = my.cores,
                   file = paste0(rds_folder_name, "so_model_summary_machine_1.rds"),
                   file_refit = "on_change")
summary(std.fit)
...
```{r points_machine_so_pas_emm_plot, echo=FALSE, fig.width=8}
