---
title: "MPA UBI vs SO (L, R; hand, machine)"
...
rds_folder_name <- "../rds/0vs180/v1/mpa/"
...
```{r hand_so_mpa_by_time_0_180, echo=FALSE, fig.width = 8}

plt[["SO MPA by Time 0min - 180min (hand)"]] <- emmc %>% emm_inorder %>% filter(Time == ".") %>% 
  ggplot(aes(y = fct_rev(interaction(Side, contrast, sep=", ", drop=TRUE)), x = .value, fill = contrast)) %>%
  my.stat_eyeh() +
  geom_vline(xintercept=0, linetype="dashed", color="black") +
  labs(title=myname, y="", x="MPA in mm, contrast: Time")

print(plt[["SO MPA by Time 0min - 180min (hand)"]])
...
```{r hand_ubi_mpa_contrasts_0_180}
...
```{r hand_ubi_mpa_by_time_0_180, echo=FALSE, fig.width = 8}

plt[["UBI MPA by Time 0min - 180min (hand)"]] <- emmc %>% emm_inorder %>% filter(Time == ".") %>% 
  ggplot(aes(y = fct_rev(interaction(Trt3, contrast, sep=", ", drop=TRUE)), x = .value, fill = Trt3)) %>%
  my.stat_eyeh() +
  geom_vline(xintercept=0, linetype="dashed", color="black") +
  labs(title=myname, y="", x="MPA in mm, contrast: Time")

print(plt[["UBI MPA by Time 0min - 180min (hand)"]])
...
```{r machine_so_mpa_contrasts_0_180}
...
```{r machine_so_mpa_by_time_0_180, echo=FALSE, fig.width = 8}

plt[["SO MPA by Time 0min - 180min (Machine)"]] <- emmc %>% emm_inorder %>% filter(Time == ".") %>% 
  ggplot(aes(y = fct_rev(interaction(Side, contrast, sep=", ", drop=TRUE)), x = .value, fill = contrast)) %>%
  my.stat_eyeh() +
  geom_vline(xintercept=0, linetype="dashed", color="black") +
  labs(title=myname, y="", x="MPA in mm, contrast: Time")

print(plt[["SO MPA by Time 0min - 180min (Machine)"]])
...
```{r machine_ubi_mpa_contrasts_0_180}
...
```{r machine_ubi_mpa_by_time_0_180, echo=FALSE, fig.width = 8}

plt[["UBI MPA by Time 0min - 180min (machine)"]] <- emmc %>% emm_inorder %>% filter(Time == ".") %>% 
  ggplot(aes(y = fct_rev(interaction(Trt3, contrast, sep=", ", drop=TRUE)), x = .value, fill = Trt3)) %>%
  my.stat_eyeh() +
  geom_vline(xintercept=0, linetype="dashed", color="black") +
  labs(title=myname, y="", x="MPA in mm, contrast: Time")

print(plt[["UBI MPA by Time 0min - 180min (machine)"]])
